function hhh=SX_hline(y,in1,in2)
% function h=SX_hline(y, linetype, label)
% 
...
%
% SX_hline([4 8 12],{'g','r','b'},{'l1','lab2','LABELC'})
%
...
if length(y)>1  % vector input
    for I=1:length(y)
        ...
        h(I)=SX_hline(y(I),linetype,label);
    end
else
    switch nargin
    case 1
