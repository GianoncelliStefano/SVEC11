...
% Section S6: solve internal actions model
    ...
    if fOK, [p_suc,T_suc] = Sinlet(p_suc , T_suc , INport_Amax, INport_Amin, V_comp(1), MM_g , n_van,rpm,c,toll_d,c_v,aQ,bQ,cQ,pipe,cpitch,ct,lenght,D_i,D_f,roughness,mu_g,dQ,eQ,fQ);
    end
