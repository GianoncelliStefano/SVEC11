function hhh=SX_vline(x,in1,in2)
% function h=SX_vline(x, linetype, label)
% 
...
%
% SX_vline([4 8 12],{'g','r','b'},{'l1','lab2','LABELC'})
%
...
if length(x)>1  % vector input
    for I=1:length(x)
        ...
        h(I)=SX_vline(x(I),linetype,label);
    end
else
    switch nargin
    case 1
